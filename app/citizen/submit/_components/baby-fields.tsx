    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1.5">
          <Label htmlFor="babyLastName" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
            Nom de famille / Surname
          </Label>
          <Input id="babyLastName" {...form.register("babyLastName")} className="h-9 text-xs rounded-md" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="babyFirstName" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
            Prénoms / Given Name
          </Label>
          <Input id="babyFirstName" {...form.register("babyFirstName")} className="h-9 text-xs rounded-md" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="babyGender" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
            Sexe / Gender
          </Label>
          <Select
        ...
        <div className="space-y-1.5">
          <Label htmlFor="birthDate" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
            Date de naissance / Date of birth
          </Label>
          <Input id="birthDate" type="date" {...form.register("birthDate")} className="h-9 text-xs rounded-md" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="birthTime" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
            Heure de naissance / Time of birth
          </Label>
          <Input id="birthTime" type="time" {...form.register("birthTime")} className="h-9 text-xs rounded-md" />
        </div>
        <div className="space-y-1.5">
          <Label htmlFor="birthPlace" className="text-[9px] font-bold text-foreground uppercase tracking-wider">
