...
export function SearchHero({
  ...
  return (
    <div className="rounded-md border border-border bg-card shadow-xs overflow-hidden">
      ...
      <div className="w-full h-0.5 flex shrink-0 select-none">
          ...
          <form action={action} className="grid gap-4 md:grid-cols-[1fr_1fr_auto] items-end">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="uppercase h-10 text-sm rounded-md focus-visible:ring-[#007A5E]"
                required
              />
            </div>
            <div className="space-y-1.5">
            ...
            <Button type="submit" className="h-10 px-6 rounded-md text-xs font-semibold uppercase tracking-wider cursor-pointer bg-[#007A5E] hover:bg-[#00664f] text-white">
