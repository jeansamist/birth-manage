    ...
    <div className="w-full border border-black border-t-0 select-none text-[7px] font-sans text-black">
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-12 p-1">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 uppercase">{motherFullName}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-6 border-r border-black p-1">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 uppercase">{motherAddress || ""}</span>
        </div>
        <div className="col-span-6 p-1">
          <span className="text-neutral-500">Durée de la résidence / Duration of residence :</span>
          <span className="font-serif italic font-bold text-blue-900 ml-1">5 ans / 5 years</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-6 border-r border-black p-1">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 uppercase">{motherProfession || ""}</span>
        </div>
        <div className="col-span-6 p-1">
          <span className="text-neutral-500">Contact / Phone number :</span>
          <span className="font-serif italic font-bold text-blue-900 ml-1">{motherPhone || ""}</span>
        </div>
      </div>
        ...
        <div className="col-span-12 p-1 flex items-center gap-2">
          ...
          <div className="flex gap-2">
            <span className="flex items-center gap-0.5">
              <span className={`inline-block w-2 h-2 border border-black text-center leading-none text-[5px] ${!parentsMarried ? "bg-neutral-800 text-white font-bold" : ""}`}>
                {!parentsMarried ? "✓" : ""}
              </span>
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-6 border-r border-black p-1">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 uppercase">{motherNationality || "CAMEROUNAISE"}</span>
        </div>
        <div className="col-span-6 p-1">
          <span className="text-neutral-500">N° CNI / ID Card No :</span>
          <span className="font-serif italic font-bold text-blue-900 ml-1 font-mono uppercase">{motherCni || ""}</span>
        </div>
      </div>

      <div className="grid grid-cols-12 p-1">
        <div className="col-span-12 flex justify-between">
          <div>Nombre d'enfants vivant durant sa vie : <span className="font-serif italic text-blue-900 font-bold">1</span></div>
