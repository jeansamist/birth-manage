    ...
    <div className="w-full border border-black border-t-0 select-none text-[9.5px] font-sans text-black">
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-12 p-2">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs uppercase">{fatherFullName || "......................................................................................"}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-6 border-r border-black p-2">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs uppercase">{fatherAddress || ""}</span>
        </div>
        <div className="col-span-6 p-2">
          <span className="text-neutral-500">Contact / Phone number :</span>
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs">{fatherPhone || ""}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 border-b border-black">
        <div className="col-span-6 border-r border-black p-2">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs uppercase">{fatherProfession || ""}</span>
        </div>
        <div className="col-span-6 p-2">
          <span className="text-neutral-500">Niveau de scolarité / Level of education :</span>
          <div className="flex gap-3 mt-0.5">
            <span className="flex items-center gap-1">
              <span className="inline-block w-2.5 h-2.5 border border-black"></span>
              <span>Primaire</span>
            </span>
            <span className="flex items-center gap-1">
              <span className="inline-block w-2.5 h-2.5 border border-black"></span>
      ...
      <div className="grid grid-cols-12 p-2">
        <div className="col-span-6 border-r border-black">
          ...
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs uppercase">{fatherFullName ? (fatherNationality || "CAMEROUNAISE") : ""}</span>
        </div>
        <div className="col-span-6 pl-2">
          <span className="text-neutral-500">N° CNI / ID Card No :</span>
          <span className="font-serif italic font-bold text-blue-900 ml-1 text-xs font-mono uppercase">{fatherCni || ""}</span>
        </div>
      </div>
    </div>
  )
